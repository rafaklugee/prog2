...
typedef struct {
    ...
    int shot_max_frames, shot_frame, shot_frame_width, shot_frame_height, is_shooting, shooting_frames;
    int is_hurt, hurt_frame, hurt_max_frames, hurt_frame_width, hurt_frame_height, hurt_frame_delay, hurt_frame_counter;
    int is_dead, dead_frame, dead_max_frames, dead_frame_width, dead_frame_height, dead_frame_delay, dead_frame_counter;
    int dead_menu_cooldown;
    int is_squat_shooting;
